...
Splash.prototype = {
  ...
  loadScripts: function () {
    ...
    game.load.script('gamemenu','minjs/GameMenu.js');
    game.load.script('game', 'minjs/Game.js');
    game.load.script('gameover','minjs/GameOver.js');
    game.load.script('options', 'minjs/Options.js');
  },
